...
- [Enhancements](#enhancements)
  - [Chocolatey](#chocolatey-1)
    ...
    - [Software Tweaks](#software-tweaks-1)
    - [Tools](#tools-2)
  - [Independently](#independently)
    - [Databases](#databases-1)
    - [Hardware Tweaks](#hardware-tweaks-1)
...
- [iTunes](https://community.chocolatey.org/packages/iTunes) - organize and enjoy the music, movies, and TV shows you already have and shop for the ones you want to get.
...
- [Vivaldi](https://community.chocolatey.org/packages/Vivaldi) - web browser.
...
- [Chocolatey GUI](https://community.chocolatey.org/packages/ChocolateyGUI) - GUI on top of the chocolatey command line tool.
...
- [Docker Desktop](https://community.chocolatey.org/packages/docker-desktop) - suite of development tools, services, and automation,  to accelerate the delivery of secure applications.
...
- [Screen to GiF](https://community.chocolatey.org/packages/screentogif) - screen, webcam and sketch board recorder with an integrated editor.
...
- [VSCodium](https://community.chocolatey.org/packages/vscodium) - community-driven, freely-licensed binary distribution of Microsoft's editor.
...
- [Discord](https://community.chocolatey.org/packages/discord) - all-in-one voice and text chat for gamers.
